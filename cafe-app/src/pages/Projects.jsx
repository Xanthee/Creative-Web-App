...
export default function Projects() {
    ...
    <div className="flex flex-col w-auto h-[80vh] mt-[10VH] m-10">
        <motion.h1
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group text-white flex flex-col h-[55vh] rounded-3xl overflow-hidden">
                <a href="/frontend" className="h-[75%] w-full overflow-hidden block cursor-pointer">
                    <img 
                    src={WebDev} 
                ...
                <div className="h-[25%] bg-[#331C20]/70 p-4 flex flex-col">
                    ...
                    <span className="text-sm font-light text-[#EEDEE0]">
            ...
            <div className="text-white flex flex-col h-[55vh] rounded-3xl overflow-hidden">
                <a href="/uxdesign" className="h-[75%] w-full overflow-hidden block cursor-pointer">
                    <img 
                    src={WebDev} 
                    alt="Front-End Development" 
                    className="w-full h-full object-cover transition-transform duration-300 hover:scale-105" 
            ...
            <div className="text-white flex flex-col h-[55vh] rounded-3xl overflow-hidden">
                <a href="/uxresearch" className="h-[75%] w-full overflow-hidden block cursor-pointer">
                    <img 
                    src={WebDev} 
                    alt="Front-End Development" 
                    className="w-full h-full object-cover transition-transform duration-300 hover:scale-105" 
            ...
            <div className="text-white flex flex-col h-[355h] rounded-3xl overflow-hidden">
                <a href="/creativework" className="h-[75%] w-full overflow-hidden block cursor-pointer">
                    <img 
                    src={WebDev} 
                    alt="Front-End Development" 
                    className="w-full h-full object-cover transition-transform duration-300 hover:scale-105" 
