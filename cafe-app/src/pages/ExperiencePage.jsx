...
import UxResearch from "../assets/UxResearchIcon.png";
import CreativeWork from "../assets/CreativeWorkIcon.png";
import UxDesign from "../assets/UxDesignIcon.png";
    ...
    <div className="flex flex-col w-auto h-auto mt-[10vh] m-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="group text-white flex flex-col h-[55vh] rounded-3xl overflow-hidden">
          ...
          <div className="h-[25%] bg-[#331C20]/70 p-4 flex flex-col">
            <h1 className="text-2xl uppercase font-thin text-[#EEDEE0]">UX Research & Strategy</h1>
            <span className="text-sm font-light text-[#EEDEE0]">
              Research, strategy, and data-driven approaches to problem solving.
            </span>
          </div>
        </div>
        ...
        <div className="group text-white flex flex-col h-[55vh] rounded-3xl overflow-hidden">
          ...
          <div className="h-[25%] bg-[#331C20]/70 p-4 flex flex-col">
            <h1 className="text-2xl uppercase font-thin text-[#EEDEE0]">Visual & Creative Work</h1>
            <span className="text-sm font-light text-[#EEDEE0]">
              Exploring creativity through 3D, illustration, and digital art.
            </span>
          </div>
        </div>
      </div>
